<script lang="ts">
  ...
  // Si el backend no envía iaUnit, usamos un fallback seguro para evitar crash.
  ...
  // Extraemos las propiedades reactivas directamente del payload dinámico de Moodle
  ...
  // El resto de tus cálculos geométricos matemáticos se mantienen intactos y limpios
